        ...
        <div className="mt-20">
            <h1 className="text-center mb-10 font-orbitron">Professional Skills</h1>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
                    <div className="col-span-1 bg-gray-800 p-8 shadow-2xl">
                        <h2 className="font-orbitron text-center">
                        <FontAwesomeIcon icon={faDesktop} size='lg' className="text-pink-500 mb-3" /><br/><strong>Front-End</strong></h2>
                    ...
                    <div className="col-span-1 bg-gray-800 p-8 shadow-2xl">
                        <h2 className="font-orbitron text-center">
                        <FontAwesomeIcon icon={faCogs} size='lg' className="text-pink-500 mb-3" /><br/><strong>Back-End</strong></h2>
                        <div className="grid gap-y-10 grid-cols-3 lg:grid-cols-2 mt-8">
                    ...
                    <div className="col-span-1 bg-gray-800 p-8 shadow-2xl">
                        <h2 className="font-orbitron text-center">
                        <FontAwesomeIcon icon={faDatabase} size='lg' className="text-pink-500 mb-3" /><br/><strong>Database</strong></h2>
                        <div className="grid gap-y-10 grid-cols-3 lg:grid-cols-2 mt-8">
